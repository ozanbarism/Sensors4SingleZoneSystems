...
This strict monotonic decrease check ensures that the selected periods are not contaminated by unmodeled heat sources (e.g., solar gain, internal heat from appliances, or latent heat from a recent heating cycle). This new implementation can be found in ThermalBehavior/heating_RC_updated.py (Line 159).
